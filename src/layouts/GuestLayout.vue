...
const navigation = [
  ...
  {
    name: "About Me",
    componentName: "GuestAboutMe",
  },
  {
    name: "Professional",
    componentName: "GuestProfessional",
  },
  {
    name: "Projects",
    componentName: "GuestProjects",
  },
  {
    name: "Contact",
    componentName: "GuestContact",
  },
]
const userNavigation = [
  { name: "Sign in as admin", componentName: "GuestLogin" },
]
</script>
